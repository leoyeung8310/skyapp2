...
//skyapp3
XML_Serializer.prototype.serializeBlocks = function (block, mediaID) {
    // public: answer an XML string representing the given object
    var xml;
    this.flush(); // in case an error occurred in an earlier attempt
    this.flushMedia();
    xml = block.toXMLWithContext(this, mediaID);
    this.flush();
    return xml;
};
...
// skyapp3
BlockMorph.prototype.toXMLWithContext = BlockMorph.prototype.toScriptXMLWithContext = function (
    serializer,
    savePosition
) {
    var position,
